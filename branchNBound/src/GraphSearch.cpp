...
#include <climits>
void GraphSearch::wypiszMacierz()
{
...
int GraphSearch::BB(int start, int stop)
{
  int best = INT_MAX;
  int rozwiniecia=0;
  ...
  cout << "Rozwiniecia: "<< rozwiniecia << endl;
  delete synowie; delete ojcowie; delete wartosci;
  return best;
}


int GraphSearch::branchAndBoundWithExtendedList(int start, int stop)
{
...
bool GraphSearch::prepare(int size)
{
